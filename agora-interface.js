...
client.on("mute-video", function (evt) {
  ...
  if (remoteId != mainStreamId) {
    ...
    var modal2 = document.getElementById(evt.uid + "_container");
...
function addRemoteStreamMiniView(remoteStream) {
  ...
  if (c % 3 == 0) {
    $("#remote-streams").append(
      $("<div/>", { class: "remote-stream-container col" })
    );
  }
...
$("local-stream-container").dblclick(function () {
